...
const TRANSLATIONS = {
    en: {
        ...
        filter_required_hint: 'Select Literacy Pillar, Resource Type, Screener, and Tier to view resources.',
        filter_required_results_prompt: 'Select Literacy Pillar, Resource Type, Screener, and Tier to view results.',
    ...
    fr: {
        ...
        filter_required_hint: 'Sélectionnez le pilier de littératie, le type de ressource, l’outil de dépistage et le niveau pour voir les ressources.',
        filter_required_results_prompt: 'Sélectionnez le pilier de littératie, le type de ressource, l’outil de dépistage et le niveau pour voir les résultats.',
