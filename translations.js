...
const TRANSLATIONS = {
    en: {
        ...
        nav_lang_code: 'FR',
        program_prompt_badge: 'Literacy Interventions',
        program_prompt_welcome: 'Welcome — choose the program you want to work in.',
        program_prompt_title: 'Choose your program',
        program_prompt_desc: 'Select the program you are working in to open the right version of the app.',
        program_prompt_english_desc: 'Jump right into the English app.',
        program_prompt_french_desc: 'Choose English or French on the next step.',
        program_prompt_language_title: 'Choose your language',
        program_prompt_language_desc: 'You have chosen French Immersion',
        program_prompt_language_label: 'Which language would you like this web app to display?',
        ...
        filter_advanced_description: 'Contains optional Subtest, Grade Level, and Evidence Classification filters.',
        filter_tier_label: 'Tier',
        filter_grade_label: 'Grade Level',
        filter_required_hint: 'Select Literacy Pillar, Resource Type, Tier, and a Screener when available to view resources.',
        filter_required_results_prompt: 'Select Literacy Pillar, Resource Type, Tier, and a Screener when available to view results.',
        ...
        filter_screener_none: 'No Specific Screener',
        ...
        schedule_section_subtitle: 'Universal screening and progress monitoring timeline for your selected program',
        ...
        schedule_program_label: 'Current program',
    ...
    fr: {
        ...
        nav_lang_code: 'EN',
        program_prompt_badge: 'Literacy Interventions',
        program_prompt_welcome: 'Bienvenue — choisissez le programme avec lequel vous souhaitez travailler.',
        program_prompt_title: 'Choisissez votre programme',
        program_prompt_desc: 'Sélectionnez le programme dans lequel vous travaillez pour ouvrir la bonne version de l’application.',
        program_prompt_english_desc: 'Accédez directement à l’application en anglais.',
        program_prompt_french_desc: 'Choisissez ensuite l’anglais ou le français.',
        program_prompt_language_title: 'Choisissez votre langue',
        program_prompt_language_desc: 'Vous avez choisi l’immersion française',
        program_prompt_language_label: 'Dans quelle langue souhaitez-vous afficher cette application Web?',
        ...
        filter_advanced_description: 'Contient les filtres optionnels de sous-test, année scolaire et classification des données probantes.',
        filter_tier_label: 'Niveau (Tier)',
        filter_grade_label: 'Année scolaire',
        filter_required_hint: 'Sélectionnez le pilier de littératie, le type de ressource, le niveau et un outil de dépistage lorsqu’il y en a pour voir les ressources.',
        filter_required_results_prompt: 'Sélectionnez le pilier de littératie, le type de ressource, le niveau et un outil de dépistage lorsqu’il y en a pour voir les résultats.',
        filter_active_none: 'Aucun filtre appliqué pour le moment.',
        ...
        filter_screener_none: 'Aucun outil de dépistage spécifique',
        ...
        schedule_section_subtitle: 'Calendrier de dépistage universel et de suivi des progrès pour le programme sélectionné',
        ...
        schedule_program_label: 'Programme actif',
